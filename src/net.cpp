...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "H2Ocoin " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    {"testnet-seed.h2ocoin.org", "testnet-seed.h2ocoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. H2Ocoin is probably already running."), addrBind.ToString().c_str());
        else
